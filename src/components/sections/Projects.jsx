    ...
    >
      ...
      <div className="w-full max-w-6xl mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-center mb-20">
          {/* Video with poster (shows image until played) */}
          <div className="md:w-1/2 flex flex-col items-start">
            ...
            {/* SILENT PURSUIT text: black, left-aligned, under video */}
            <h3 className="text-3xl font-bold text-black mt-4">SILENT PURSUIT</h3>
          </div>
          {/* Description */}
        ...
        <div className="w-full bg-[#232323] rounded-xl py-12 px-6 mb-20">
          <div className="w-full max-w-4xl mx-auto flex flex-col items-center">
            ...
            <video
              ...
              src="The reality of an international student in the United States.mp4"
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div>
              ...
              <video
                ...
                src="STRAIGHT FROM MY HEART.mp4"
            ...
            <div className="md:w-1/2 flex flex-col justify-center mb-6 md:mb-0">
              <h3
                style={{
                  ...
                  fontSize: "2rem",
                  letterSpacing: "0.1em",
                  color: "#eccec6", // All letters in #eccec6
                  lineHeight: 1.2,
                  marginBottom: "2rem",
                  textAlign: "left",
